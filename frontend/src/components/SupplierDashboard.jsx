                                                ...
                                                <div key={tx.poNumber} className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden shadow-sm">
                                                    ...
                                                    <div className="p-4 bg-slate-900 border-b border-slate-800">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <div className="flex-1 h-1 bg-slate-700"><div className={`h-full bg-emerald-500 ${tx.events.some(e => e.label.includes('Approved')) ? 'w-full' : 'w-0'}`}></div></div>
                                                            <div className="flex-1 text-center"><div className={`w-6 h-6 mx-auto rounded-full flex items-center justify-center text-xs ${tx.events.some(e => e.label.includes('Approved')) ? 'bg-emerald-500 text-white' : 'bg-slate-700 text-slate-500'}`}>2</div><p className="text-[10px] mt-1 font-bold text-slate-400">Finance Approved</p></div>
