...
const { sendSupplierEmail } = require('./mailer'); // 📧 Import mailer
    ...
    try {
        ...
        if (boqData.supplier_email) {
            const emailHtml = `
                ...
                <p><strong>PO Number:</strong> ${generatedPoNumber}</p>
                <p><strong>Total Amount:</strong> ${boqData.currency} ${boqData.total_amount}</p>
                <p>Please log in to your Supplier Dashboard to view, download the PO, and proceed with delivery.</p>
