                                            ...
                                            <td className="p-4">
                                                <div className="flex gap-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-1.5 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-800/50 text-blue-600 dark:text-blue-400 rounded-md transition-colors"
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-1.5 bg-purple-100 dark:bg-purple-900/30 hover:bg-purple-200 dark:hover:bg-purple-800/50 text-purple-600 dark:text-purple-400 rounded-md transition-colors"
                                                        title="Preview PO"
                                                    >
                                                        📑
                                                    </button>
                                                    ...
                                                    {relatedBoq && (
                                                        <button
                                                            ...
                                                            className="p-1.5 bg-emerald-100 dark:bg-emerald-900/30 hover:bg-emerald-200 dark:hover:bg-emerald-800/50 text-emerald-600 dark:text-emerald-400 rounded-md transition-colors"
                                                            title="Preview BOQ"
                                                        >
                                                            📜
                                                        </button>
