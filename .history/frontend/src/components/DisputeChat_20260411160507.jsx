        ...
        if (chatMode === 'ai') {
            ...
            try {
                ...
                if (cleanKey === '') {
                    ...
                    - If they ask about the status of this specific document, explicitly refer to the "Current System Status" provided above.
                    ${userRole === 'Finance'
                            ? `- Role: Internal Finance Assistant. Help the agent review discrepancies, approve documents, or answer process questions.`
                            : `- Role: Supplier Assistant. Help the supplier understand why a document is pending or rejected, answer payment timeline questions (Invoices are paid Net-30 AFTER warehouse goods are scanned and approved), and provide supportive guidance.`
                        }
