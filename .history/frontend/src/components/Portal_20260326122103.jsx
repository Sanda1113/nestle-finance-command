        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6">
                {loading ? (
                    ...
                    boqs.map(boq => {
                        const isApproved = boq.status.startsWith('PO_GENERATED');
                        const poNumber = isApproved ? boq.status.split(':')[1] : null;
                                    ...
                                    <div>
                                        ...
                                        {isApproved ? (
                                            <div className="p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-xl border border-emerald-200 dark:border-emerald-800/50">
                                                ...
                                                <p className="text-sm font-black text-emerald-800 dark:text-emerald-300">{poNumber}</p>
                                            </div>
                                        ) : (
