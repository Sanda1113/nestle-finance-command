        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans flex flex-col transition-colors duration-300 relative">
            ...
            {scanning && (
                <div className="fixed inset-0 z-[100] bg-slate-950/95 backdrop-blur-md flex flex-col items-center justify-center p-4 animate-in fade-in zoom-in-95 duration-300">
                    ...
                    {/* Close Button */}
                    <button onClick={() => setScanning(false)} className="absolute top-6 right-6 bg-slate-800 text-white p-3 rounded-full hover:bg-slate-700 transition-colors shadow-lg z-50">
                        <X className="w-6 h-6" />
                    </button>
                    ...
                    {/* The New Robust Scanner Component */}
                    <div className="w-full max-w-md">
                        <BarcodeScannerUI
                            onScanSuccess={(decodedText) => {
                                setScanning(false);
                                // Pass the result to your existing process function
                                processScanResult(decodedText);
                            }}
                        />
                    </div>
