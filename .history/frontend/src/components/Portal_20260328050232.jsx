                                    ...
                                    <>
                                        <tr key={r.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30">
                                            ...
                                            <td className="p-4 text-right space-x-2">
                                                {/* 🚀 FIXED: Removed disabled prop. Finance team can now override ANY document at ANY time. Stop propagation added. */}
                                                <button onClick={(e) => { e.stopPropagation(); handleManualOverride(r.id, 'Approved'); }} className="px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wide rounded bg-slate-100 dark:bg-slate-800 hover:bg-emerald-500 hover:text-white transition-colors text-slate-600 dark:text-slate-300">Approve</button>
                                                <button onClick={(e) => { e.stopPropagation(); handleManualOverride(r.id, 'Rejected'); }} className="px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wide rounded bg-slate-100 dark:bg-slate-800 hover:bg-red-500 hover:text-white transition-colors text-slate-600 dark:text-slate-300">Reject</button>
                                            </td>
                                        </tr>
