                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        {filteredPOs.length === 0 ?
                                            ...
                                            : filteredPOs.map(po => {
                                                ...
                                                const hasSubmittedDocs = myLogs.some(log => ((log.type || '').includes('Match') || (log.type || '').includes('Reconciliation')) && log.ref === po.po_number);
                                                                ...
                                                                <div key={log.id} className="relative pl-5">
                                                                    ...
                                                                    <div className="flex flex-col">
                                                                        <div className="flex justify-between items-start">
                                                                            <div>
                                                                                <h3 className="text-sm font-bold text-slate-100">{log.action} <span className="text-slate-400 font-normal">({logType})</span></h3>
                                                                            </div>
