...
export default function SupplierDashboard({ user, onLogout }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (invoiceRes.data.success && poRes.data.success) {
                ...
                // 🛡️ STRICT MATCHING LOGIC: Both must be greater than zero AND match exactly
                let status = 'Rejected';
    ...
    // The beautiful card component to display extracted data
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <div className="p-8 max-w-7xl mx-auto mt-6">
                ...
                {/* The side-by-side extracted data display */}
