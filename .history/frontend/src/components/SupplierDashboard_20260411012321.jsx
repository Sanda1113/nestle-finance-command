    ...
    const handleMatchUpload = async () => {
        ...
        try {
            ...
            if (invRes.data.success && poRes.data.success) {
                ...
                // FIX: Send to Finance Queue for Review first, no instant auto-approval to payout
                let status = 'Finance Review Pending';
                if (invData.totalAmount !== poData.totalAmount) {
                    status = 'Discrepancy Detected'; // Flags it for Finance to check closer
                }
