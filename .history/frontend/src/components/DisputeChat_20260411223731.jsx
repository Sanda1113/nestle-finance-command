    ...
    const sendMessage = async (text = newMessage, forceRole = userRole, metadata = null) => {
        ...
        if (chatMode === 'ai') {
            ...
            try {
                ...
                // Override with message-based detection if needed
                ...
                if (cleanKey === '') {
                    ...
                    YOUR PERSONA & TASK:
                    - Act as an autonomous, helpful expert. Answer questions about this document, general supply chain processes, or math freely.
                    - DO NOT sound like a robot reading a script. Converse naturally.
                    - Only explicitly refer to the "Current System Status" if they ask for an update on their document.
                    
                    ${userRole === 'Finance'
                            ? `- Role: Internal Finance Assistant. Help the agent review discrepancies, approve documents, or answer process questions.
                         - If the status is "Matched - Pending Finance Review", confirm that the supplier's invoice and PO match perfectly and they can safely click Approve.`
                            : `- Role: Supplier Assistant. Help the supplier understand why a document is pending or rejected.
                         - If the status is "Matched - Pending Finance Review", reassure the supplier that the numbers match and it's just waiting for Finance to click approve so they can deliver the goods.
                         - Remind them that invoices are paid Net-30 AFTER warehouse goods are scanned and approved.`
                        }
