        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            <div className="bg-slate-900 p-4 px-8 flex justify-between items-center text-white shadow-md">
                ...
                <div className="flex items-center gap-4">
                    <span className="text-sm text-slate-400 font-bold hidden sm:block">User ID: {user.id?.slice(0, 8) || user.email}</span>
                            ...
                            {myPOs.length === 0 ? (
                                ...
                                myPOs.map(po => (
                                    <div key={po.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border-t-4 border-purple-500 p-6 flex flex-col justify-between">
                                        ...
                                        <button onClick={() => handlePrintPO(po)} className={`w-full py-3 font-bold rounded-xl transition-colors ${po.is_downloaded ? 'bg-slate-100 text-slate-700 hover:bg-slate-200' : 'bg-purple-600 hover:bg-purple-500 text-white'}`}>
                                            {po.is_downloaded ? "📥 Download Again" : "📄 Download PDF"}
                                        </button>
                                    </div>
                                ))
                            )}
                ...
                {mode === 'boq' && (
                    <div className="max-w-4xl">
                        ...
                        <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-slate-200 mt-6">
                            ...
                            {/* 🚀 Supported Files Include Excel & CSV */}
