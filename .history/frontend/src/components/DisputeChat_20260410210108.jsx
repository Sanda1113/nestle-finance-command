...
export default function DisputeChat({ referenceNumber, userEmail, userRole, varianceType, onResubmit, contextData }) {
    ...
    // This is the Helpdesk Support Ticket status, NOT the actual shipment status!
        ...
        if (chatMode === 'ai') {
            ...
            try {
                ...
                if (cleanKey === '') {
                    ...
                    - Current Document Status: ${actualDocumentStatus}
                    - Known Variance/Issue: ${varianceType || 'None'}
                    - Helpdesk Ticket Status: ${disputeStatus}
                    ...
                    1. Answer the user's query STRICTLY based on the "Current Document Status" provided above.
                    2. If the status is "Rejected", explicitly state that it has been rejected by Procurement/Finance. DO NOT say it is on track. Tell them to check the timeline reason or submit a new document.
                    ...
                    6. If they need manual human help, tell them to click "Live Agent" at the top of the chat to speak with the Finance Team.`;
    ...
    // 🗂️ Determine which array to render based on current mode
