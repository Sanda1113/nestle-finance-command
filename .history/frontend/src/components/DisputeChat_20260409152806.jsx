    ...
    const sendMessage = async (text = newMessage, forceRole = userRole, metadata = null) => {
        ...
        if (chatMode === 'ai') {
            ...
            try {
                ...
                const cleanKey = GEMINI_API_KEY.trim(); // Cleans any accidental spaces/newlines
                ...
                if (cleanKey === 'YOUR_GEMINI_API_KEY_HERE' || cleanKey === '') {
                    ...
                    // LIVE API CALL TO GOOGLE GEMINI USING NATIVE FETCH
                ...
                const errorMsg = {
                    id: Date.now() + 1,
                    sender_role: 'AI System',
                    message: "⚠️ AI Server is temporarily unreachable or your API Key is restricted. Please check the console for details, or switch to Live Agent mode.",
                    created_at: new Date().toISOString()
                };
