...
function FinancePortal() {
    ...
    const handleManualOverride = async (id, decision) => {
        // 🚀 NEW: Confirmation prompt before acting
                    ...
                    <table className="w-full text-left text-sm min-w-[800px]">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {filteredRecords.map((r) => {
                                // 🚀 FIXED: Only lock if the Finance team specifically actioned it.
                                // Unlocks AI auto-approved ones so Finance can override them!
