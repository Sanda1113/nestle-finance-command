            ...
            <div className="relative z-10 w-full max-w-sm animate-fade-in-up">
                <div className="bg-slate-900/60 backdrop-blur-2xl p-8 rounded-3xl shadow-2xl border border-slate-700/50">
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg shadow-blue-500/30 mb-5 border border-white/10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isLoginView ? 'max-h-0 opacity-0' : 'max-h-24 opacity-100 pt-2'}`}>
                            <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">
                                Account Type
                            </label>
                            <div className="grid grid-cols-2 gap-2 bg-slate-950/50 p-1 rounded-xl border border-slate-800 shadow-inner">
                                <button
                                    type="button"
                                    onClick={() => setRole('supplier')}
                                    className={`py-2 text-xs font-bold rounded-lg transition-all duration-300 ${role === 'supplier'
                                ...
                                <button
                                    ...
                                    className={`py-2 text-xs font-bold rounded-lg transition-all duration-300 ${role === 'finance'
                                        ? 'bg-slate-800 text-white shadow-sm border border-slate-700'
                                        : 'text-slate-500 hover:text-slate-300 border border-transparent'
                                        }`}
                                >
