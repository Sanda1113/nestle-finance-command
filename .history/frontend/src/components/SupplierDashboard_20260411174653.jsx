...
export default function SupplierDashboard({ user, onLogout }) {
    ...
    const transactionTimeline = useMemo(() => {
        return myPOs.map(po => {
            ...
            // 3. Invoice & Matching (if reconciliation exists)
            if (relatedRecon) {
                events.push({
                ...
                // 6. Payout (after approval and delivery)
        ...
        }).filter(t => t.events.length > 0); // Only show transactions with at least a PO
                ...
                <div className="p-4 md:p-6 max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            {/* 🆕 LIFECYCLE TIMELINE TAB (UPDATED) */}
                            {mode === 'logs' && (
                                <div className="animate-in fade-in duration-300">
                                    <div className="mb-4">
