        ...
        if (chatMode === 'ai') {
            ...
            try {
                ...
                if (messages.some(m => m.message.toLowerCase().includes('reject'))) {
                    actualDocumentStatus = 'Rejected by Finance';
                }
                ...
                if (cleanKey === '') {
                    ...
                    1. BOQ (Quote) -> Submitted by Supplier. Can be "Rejected" or "Approved".
                    2. Invoice Match -> Submitted by Supplier. Status becomes "Finance Team Checking".
                    ...
                    2. IF THE STATUS SAYS 'Rejected' or 'Reject', EXPLICITLY state that it has been rejected by Finance/Procurement. Advise them to submit a new document or check the Live Agent chat for the reason.
