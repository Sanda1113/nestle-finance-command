    ...
    const html = `
        ...
        <body>
            <div class="header">
                <div>
                    <h1>${docType}</h1>
                    <p><strong>Document Number:</strong> ${docData.invoiceNumber || docData.poNumber}</p>
                            ...
                            <div key={boq.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col md:flex-row">
                                ...
                                <div className="p-6 md:w-2/3 flex flex-col">
                                    <div className="flex justify-between items-center mb-3">
                                        ...
                                        <button onClick={() => handlePrintDocument('BOQ / Estimate', boq)} className="text-xs font-bold text-blue-500 hover:underline">📄 Download BOQ PDF</button>
                                    </div>
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {filteredRecords.map((r) => (
                                <>
                                    ...
                                    {/* EXPANDED ROW LOGIC WITH DOWNLOAD BUTTONS */}
                                    {expandedRow === r.id && (
                                                ...
                                                <div className="grid grid-cols-2 gap-6">
                                                    <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                                                        <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-2 mb-2">
                                                            <h4 className="font-bold text-slate-700 dark:text-slate-300">Invoice Summary</h4>
                                                            <button onClick={() => handlePrintDocument('Invoice', r.invoice_data)} className="text-xs font-bold text-blue-500 hover:underline">📄 Download PDF</button>
                                                        </div>
                                                    ...
                                                    <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                                                        <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-2 mb-2">
                                                            ...
                                                            <button onClick={() => handlePrintDocument('Purchase Order', r.po_data)} className="text-xs font-bold text-purple-500 hover:underline">📄 Download PDF</button>
                                                        </div>
