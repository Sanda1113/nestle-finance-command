...
import { Package, Truck, CheckCircle2, AlertCircle, ScanBarcode, ArrowLeft, Camera, Search, EyeOff, Eye, CalendarDays, Hash, ShieldAlert, ShieldCheck, WifiOff, MapPin, RefreshCw, LogOut, Moon, Sun, X, Bot } from 'lucide-react';

// ==========================================
// 🛡️ SECURE LIVE SCANNER COMPONENT
// ==========================================
// This component forces a physical user tap to start the camera, bypassing iOS/Android Auto-Play Security Blocks.
...
export default function WarehousePortal({ user, onLogout }) {
    ...
    const handleImageUpload = async (event) => {
        ...
        try {
            // Method 1: Try Native On-Device AI Vision (iOS 17+ / Chrome / Android)
            ...
            // Method 2: Software Fallback (html5-qrcode)
            ...
            console.error(err);
            alert("❌ AI Vision could not confidently read the barcode.\n\nTips:\n- Ensure the image is well-lit.\n- Ensure the barcode is perfectly in focus.\n- Crop the image closer to the barcode.");
        } finally {
            setIsProcessingImage(false);
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans flex flex-col transition-colors duration-300 relative">
            ...
            {isProcessingImage && (
                <div className="fixed inset-0 z-[200] bg-slate-950/90 backdrop-blur-sm flex flex-col items-center justify-center p-6">
                    ...
                    <h2 className="text-white font-bold text-xl text-center">AI Vision Engine Processing...</h2>
                    <p className="text-slate-400 text-sm mt-2 text-center">Decoding barcode from image matrix</p>
                </div>
            )}
