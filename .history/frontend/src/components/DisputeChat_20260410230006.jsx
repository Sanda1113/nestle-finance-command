    ...
    const sendMessage = async (text = newMessage, forceRole = userRole, metadata = null) => {
        ...
        if (chatMode === 'ai') {
            ...
            try {
                ...
                // INTELLIGENT OVERRIDE: Check Chat History for Rejections just in case contextData is stale
                ...
                if (cleanKey === '') {
                    ...
                    CRITICAL REAL-TIME DATA (DO NOT HALLUCINATE):
                    ...
                    2. IF THE STATUS SAYS 'Rejected' or 'Reject', EXPLICITLY state that it has been rejected by Finance/Procurement. DO NOT say it is open or on track. Advise them to submit a new document or check the Live Agent chat for the reason.
                    3. IF THE STATUS SAYS 'Pending Warehouse GRN', explicitly state that the invoice CANNOT be paid until the physical goods are scanned and verified at the Nestle Warehouse dock.
                    4. Keep it concise (2-3 sentences max).
                    5. If they need human help or file uploads, tell them to click "Live Agent" at the top of the chat to speak with the Finance Team.`;
