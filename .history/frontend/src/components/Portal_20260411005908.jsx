        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            <div className="md:w-64 bg-slate-900 dark:bg-slate-900 text-slate-300 flex flex-col shadow-2xl z-10 shrink-0">
                ...
                <div className="p-4 border-t border-slate-800 space-y-2">
                    <button onClick={() => window.location.reload()} className="w-full py-2 mb-2 bg-slate-800 hover:bg-blue-600 rounded-lg text-sm font-bold text-white transition-colors flex items-center justify-center gap-2">
                                ...
                                return (
                                    <>
                                        <tr key={r.id} className={`hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors ${isExpanded ? 'bg-slate-50 dark:bg-slate-800/20' : ''}`}>
                                            ...
                                            <td className="p-4">
                                                <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ring-1 ring-inset ${r.displayStatus.includes('Approved') ? 'bg-emerald-50 text-emerald-600 ring-emerald-500/20' : r.displayStatus.includes('Pending') ? 'bg-amber-50 text-amber-600 ring-amber-500/20' : 'bg-red-50 text-red-600 ring-red-500/20'}`}>
                                                    {r.displayStatus}
                                                </span>
                                            </td>
