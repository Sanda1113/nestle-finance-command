...
function FinancePortal({ user }) {
    ...
    const enrichedRecords = records.map(r => {
        ...
        // 🛡️ DYNAMIC OVERRIDE LOGIC TO ENSURE "MATCHED - PENDING FINANCE REVIEW"
        if (displayStatus === 'Matched - Pending Finance Review' || displayStatus === 'Pending' || displayStatus === 'Finance Review Pending' || !displayStatus) {
            displayStatus = 'Matched - Pending Finance Review';
        } else if (displayStatus.includes('Discrepancy') || displayStatus.includes('Manual')) {
